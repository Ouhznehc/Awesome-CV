...
%---------------------------------------------------------
  \cventry
    ...
    {American Mathematical Contest in Modeling (S Award)} % Organization
    ...
    {Mar. 2023} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Combined heuristic learning and hierarchical multivariate regression methodology with deep forest algorithm to build a versatile predictive model; obtained over 90% rate of accuracy through continuous iteration; synthesized
